...
$(document).ready(function(){
	...
	$("#insertBtn").on("click", function() {
		...
		$("#actionForm").attr("action", "tboardInsert");
		$("#actionForm").submit();
	});
	...
	$("tbody").on("click","tr",function(){
		...
		$("#actionForm").attr("action","tboardDetail");
		$("#actionForm").submit();
	});
...
<body>
	...
	<!-- 로그인 안됐을 때  로그인 버튼이 보여진다. -->
	<!-- 로그인됐을때 닉네임과 로그아웃 버튼이 보여진다. -->
	<c:import url="/testHeader"/>
	<!-- 공통영역 파일을 하나로 만들어서 사용한다. LoginController.java에서 만들었다.(흐름을 보면 된다.) -->
